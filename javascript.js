var drinksSearched = [];
var drinksSearchedLocal = JSON.parse(localStorage.getItem("drinksSearched")) || [];
...
var inputdrinkEl = $("#inputdrink").value;

document.getElementById("submit-button").addEventListener('click', handleSearchFormSubmit);
var inputdrinkEl = document.querySelector('#inputdrink').value;

function handleSearchFormSubmit(event) {
  event.preventDefault();
  
searchURL = ("https://www.thecocktaildb.com/api/json/v1/1/search.php?s=" + inputdrinkEl);
fetch(searchURL)
